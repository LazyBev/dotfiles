...
;; Force Wayland clipboard (Hyprland / wl-clipboard)
...
;; NOTE: `all-the-icons` must go in packages.el, not here!
;; (package! all-the-icons) ;; <-- REMOVE or comment out this line in config.el
